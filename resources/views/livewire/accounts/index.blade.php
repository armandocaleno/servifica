<div>
    <div class="flex space-x-2 mb-4 ">  
        ...
        {{-- New input button --}}      
        <a href="{{ route('accounts.create') }}" class="px-4 py-2 bg-orange-500 rounded-md font-semibold text-white shadow-md hover:bg-opacity-80 focus:outline-none focus:ring active:text-gray-700 disabled:opacity-25 transition">Nuevo</a>               
    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="row font-medium">
                                        <div class="flex space-x-4">                                                                                        
                                            ...
                                            <a href="{{ route('accounts.edit', $item) }}" class="text-gray-600 hover:opacity-50"><i class="fa-solid fa-pen-to-square"></i></a>
