<div>
    <div class="flex space-x-2 mb-4 ">  
        {{-- Search --}}            
        <x-jet-input type="text" class="flex-1" wire:model="search" placeholder="Buscar por número, proveedor o referencia..."/>             
        
        {{-- New input button --}}    
        @can('transactions.expenses.create') 
            <a href="{{ route('expenses.create') }}" class="px-4 py-2 bg-orange-500 rounded-md font-semibold text-white shadow-md hover:bg-opacity-80 focus:outline-none focus:ring active:text-gray-700 disabled:opacity-25 transition">Nuevo</a>               
        @endcan 
    </div>
                                    ...
                                    <td class="row font-medium">
                                        <div class="flex space-x-4">                                                                                        
                                            @can('transactions.expenses.edit') 
                                                <a href="{{ route('expenses.edit', $item) }}" class="text-gray-600 hover:opacity-50"><i class="fa-solid fa-pen-to-square"></i></a>
                                            @endcan   
