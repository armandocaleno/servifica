<div class="bg-gray-50 border-2 p-4">
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 mb-4">
        ...
        <div class="flex items-center space-x-2">
            <x-jet-label value="Debe:" />
            <select name="" class="py-0 rounded border-gray-400 w-full text-gray-600" wire:model.defer="type">
                ...
                <table class="min-w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="thead w-32">Debe</th>
                            <th class="thead w-32">Haber</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        @else
                            <tr>
                                <td colspan="4" class="text-center text-gray-400">No ha seleccionado ninguna cuenta
                                </td>
                            </tr>
                            <tr>
                    ...
                    <tfoot>
                        <tr>
                            <td></td>
                            <td class="row text-right">$ {{ $total_debe }}</td>
                            <td class="row text-right">$ {{ $total_haber }}</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
