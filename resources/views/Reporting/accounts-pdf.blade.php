...
<body>
    <header>
        ...
        <h1 class="font-bold text-lg text-center">REPORTE DE CUENTAS</h1>  
    ...
    <div id="content" class="align-middle min-w-full mt-4">
        <table class="w-full text-sm">
            <thead class="head text-sm rounded">                            
                <th class="px-2 py-2 text-left leading-4">Trans. #</th>
                ...
                <th class="px-2 py-2 text-right leading-4">Valor</th>   
            </thead>
            <tbody class="border">
                @foreach ($transactions as $item)
                    <tr class="border">                                            
                        ...
                        <td class="px-2 whitespace-no-wrap">{{ $item['partner_name'] }} {{ $item['partner_lastname'] }}</td>    
